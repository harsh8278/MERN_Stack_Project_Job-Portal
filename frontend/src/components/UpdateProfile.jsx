...
const UpdateProfile = () => {
  ...
  const handleUpdateProfile = () => {
    ...
    if (user && user.role === "Job Seeker") {
      fromData.append("firstNiche", firstNiche);
      fromData.append("secondNiche", secondNiche);
      fromData.append("thirdNiche", thirdNiche);
            ...
            <div>
              ...
              <input type='file' onChange={resumeHandler} />
              {
                user && user.resume && (
                  <div>
                    <p>Current Resume:</p>
                    <Link to={user && user.resume.url} target='_blank' className='view-resume'>View Resume</Link>
                  </div>
                )
              }
            </div>
