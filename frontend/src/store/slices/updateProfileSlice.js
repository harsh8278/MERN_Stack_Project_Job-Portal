...
export const updateProfile = (data) => async (dispatch) => {
    ...
    try {
        const response = await axios.put("http://localhost:3004/api/v1/user/update/profile", data, {
...
export const updatePassword = (data) => async (dispatch) => {
    ...
    try {
        const response = await axios.put("http://localhost:3004/api/v1/user/update/password", data, {
            withCredentials: true,
